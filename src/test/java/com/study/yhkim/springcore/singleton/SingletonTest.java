...
public class SingletonTest {
    ...
    @Test
    @DisplayName("스프링 없는 순수한 DI 컨테이너 - Not Singleton")
    void pureContainer() {
    ...
    void  singletonServiceTest() {
        ...
        //SingletonService() 는 private 생성자 외부에서 new 키워드로 객체 인스턴스 s 를 생성할 수 없음
    ...
    void springContainer() {
        /*
        스프링 컨테이너를 사용하면 복잡한 싱글톤 패턴을 적용하지 않고도 기본적으로 @Bean 등록한 객체를 싱글톤으로 관리한다.
        */
